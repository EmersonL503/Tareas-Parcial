...
<div class="row">
            ...
            <div class="card card-body">
                ...
                <form action="editar_tarea.php?idtareas=<?php echo $_GET['idtareas']; ?>" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="titulo" class="form-control" placeholder="CRUD TAREAS" required value="<?php echo $nombre_completo; ?>">
                            </div>
                            <div class="form-group">
    ...
    <input type="submit" class="btn btn-success btn-block" value="Actualizar Datos" name="actualizar">
